...
export default class NotifService {
  ...
  localNotif(soundName, title, subtitle, message) {
    this.lastId++;
    PushNotification.localNotification({
      ...
      smallIcon: null, // (optional) default: "ic_notification" with fallback for "ic_launcher"
      color: null, // (optional) default: system default
      vibrate: true, // (optional) default: true
      vibration: 300, // vibration length in milliseconds, ignored if vibrate=false, default: 1000
      groupSummary: false, // (optional) set this notification to be the group summary for a group of notifications, default: false
      ongoing: false, // (optional) set whether this is an "ongoing" notification
      invokeApp: true, // nal) This enable click on actions to bring back the application to foreground or stay in background, default: true
      ...
      subtitle: subtitle ? subtitle : '', // (optional) smaller title below notification title
