      ...
      <PersistGate loading={null} persistor={persistor}>
        <NavigationContainer>
          <Drawer.Navigator
            ...
            />
            <Drawer.Screen
              name={I18nJs.t('fingerPrintHeader')}
              component={FingerPrintScannerPage}
            />
            <Drawer.Screen
              name={I18nJs.t('cameraHeader')}
              component={CameraPage}
            />
            <Drawer.Screen name={I18nJs.t('mapHeader')} component={MapPage} />
            <Drawer.Screen
              name={I18nJs.t('webViewHeader')}
              component={WebViewPage}
            />
            <Drawer.Screen
              name={I18nJs.t('modalHeader')}
              component={ModalPage}
            />
            <Drawer.Screen
              name={I18nJs.t('signatureHeader')}
